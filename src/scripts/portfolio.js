let projects = [
  {
    ...
    tech: 'VueJS / NodeJS',
    desc: 'Web application demo created using Vue.js, vuetify and Node.js. with database in mongoDB Multilanguage template based on an important hotel located in Spain, created from scratch with main page, administrator CRUD and reservation system.',
  ...
  },
  {
    ...
    tech: 'VueJS / NodeJS',
    desc: 'Web application created using Vue.js, vuetify and Node.js with a database in Firebase. Multilanguage Project destined for an important hotel in Colombia with a CRUD administrator where the loading and uploading of data and photos is handled.',
    github: '',
  ...
  },
  {
    ...
    tech: 'Bootstrap / PHP',
    desc: 'Web page created with Bootstrap and php with a Mysql database simulating a website to buy fruit, with user login, a customer and product management system for sale',
    github: '',
  ...
  },
  {
    ...
    desc: 'Mobile application demo created using Vue.js, Electron, and Node.js with MySQL database, file upload with cloudinary and Stripe payment gateway. Project for a chain of gyms where the goal is to keep customers in touch, offer exclusive services and plans, upload plans and help routines for new ones, and make new friends. ',
